...
function scrollActive(){
    ...
    sections.forEach(current =>{
        ...
        const sectionId = current.getAttribute('id') // Adiciona a palavra-chave "const" aqui

        const menuLink = document.querySelector('.nav__menu a[href*="' + sectionId + '"]'); // Adiciona aspas duplas ao redor do valor do atributo
